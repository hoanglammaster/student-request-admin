 ...
 * @author Hoang Lam
 */
public class SolveRequest2Servlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SolveRequest2Servlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SolveRequest2Servlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            updater.update(requestFully, Updatable.MYSELT);

            AppUtilsFactory.getNotifier().sendNotify("Save success!", response);
        } catch (NumberFormatException ex) {
            Logger.getLogger(SolveRequest2Servlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
