...
import model.util.data.transfer.FileDownloadable;
...
//        processRequest(request, response);
        if(request.getSession().getAttribute("file")!= null){
            ...
            FileDownloadable fileDownloader = DataTransferFactory.getFileDowload();
            fileDownloader.download(file, response);
        }
//        if (request.getParameter("file") != null) {
//            int fileId = Integer.parseInt(request.getParameter("file"));
//            Connections connectionner = SqlServerFactory.getConnectioner();
//            Convertible<File> converter = ConverterFactory.getFileConverter();
//            Gettable<File> getter = FileDao.getFileGetter(connectionner, converter);
//            File file = getter.get(fileId);
//
//            FileDownloadable fileDownloader = DataTransferFactory.getFileDowload();
//            fileDownloader.download(file, response);
//        }
